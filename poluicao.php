            ...
            <tr class="dif">
             ...
             <?php
                ...
                ?>
                        <tr>    
                            <td class="dif1">
                            <?php echo $tbl["id_poluicao"]; ?></td>
                            <td><?php echo $tbl["tipop"]; ?></td>
                            <td><?php echo $tbl["municipiop"]; ?></td>
                            <td><?php echo $tbl["bairrop"]; ?></td>
                            <td><?php echo $tbl["ruap"]; ?></td>
                            <td><?php echo $tbl["mensagemp"]; ?></td>
