...
<html lang="en">
 ...
 <?php
           ...
           include "conexao.php";
            ...
            $consulta= "SELECT * FROM desmatamento";
            ...
            <tr class="dif">
             ...
             <?php
                ...
                ?>
                        <tr>    
                            <td class="dif1">
                            <?php echo $tbl["id_desmatamento"]; ?></td>
                            <td><?php echo $tbl["tipod"]; ?></td>
                            <td><?php echo $tbl["municipiod"]; ?></td>
                            <td><?php echo $tbl["bairrod"]; ?></td>
                            <td><?php echo $tbl["ruad"]; ?></td>
                            <td><?php echo $tbl["mensagemd"]; ?></td>
