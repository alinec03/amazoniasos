            ...
            <tr class="dif">
             ...
             <?php
                ...
                ?>
                        <tr>    
                            <td class="dif1">
                            <?php echo $tbl["id_trafico"]; ?></td>
                            <td><?php echo $tbl["tipot"]; ?></td>
                            <td><?php echo $tbl["municipiot"]; ?></td>
                            <td><?php echo $tbl["bairrot"]; ?></td>
                            <td><?php echo $tbl["ruat"]; ?></td>
                            <td><?php echo $tbl["mensagemt"]; ?></td>
